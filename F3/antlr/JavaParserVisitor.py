...
class JavaParserVisitor(ParseTreeVisitor):
    ...
    # Visit a parse tree produced by JavaParser#intLit.
    def visitIntLit(self, ctx:JavaParser.IntLitContext):
        return self.visitChildren(ctx)


    # Visit a parse tree produced by JavaParser#floatLit.
    def visitFloatLit(self, ctx:JavaParser.FloatLitContext):
        return self.visitChildren(ctx)


    # Visit a parse tree produced by JavaParser#charLit.
    def visitCharLit(self, ctx:JavaParser.CharLitContext):
        return self.visitChildren(ctx)


    # Visit a parse tree produced by JavaParser#strLit.
    def visitStrLit(self, ctx:JavaParser.StrLitContext):
        return self.visitChildren(ctx)


    # Visit a parse tree produced by JavaParser#boolLit.
    def visitBoolLit(self, ctx:JavaParser.BoolLitContext):
        return self.visitChildren(ctx)


    # Visit a parse tree produced by JavaParser#nullLit.
    def visitNullLit(self, ctx:JavaParser.NullLitContext):
        return self.visitChildren(ctx)


    # Visit a parse tree produced by JavaParser#textLit.
    def visitTextLit(self, ctx:JavaParser.TextLitContext):
        return self.visitChildren(ctx)
