# Generated from C:/Users/breng/OneDrive/Desktop/F3/antlr\JavaParser.g4 by ANTLR 4.10.1
from antlr4 import *
...
class JavaParserListener(ParseTreeListener):
    ...
    # Enter a parse tree produced by JavaParser#intLit.
    def enterIntLit(self, ctx:JavaParser.IntLitContext):
        pass

    # Exit a parse tree produced by JavaParser#intLit.
    def exitIntLit(self, ctx:JavaParser.IntLitContext):
        pass


    # Enter a parse tree produced by JavaParser#floatLit.
    def enterFloatLit(self, ctx:JavaParser.FloatLitContext):
        pass

    # Exit a parse tree produced by JavaParser#floatLit.
    def exitFloatLit(self, ctx:JavaParser.FloatLitContext):
        pass


    # Enter a parse tree produced by JavaParser#charLit.
    def enterCharLit(self, ctx:JavaParser.CharLitContext):
        pass

    # Exit a parse tree produced by JavaParser#charLit.
    def exitCharLit(self, ctx:JavaParser.CharLitContext):
        pass
    ...
    # Exit a parse tree produced by JavaParser#strLit.
    def exitStrLit(self, ctx:JavaParser.StrLitContext):
        pass


    # Enter a parse tree produced by JavaParser#boolLit.
    def enterBoolLit(self, ctx:JavaParser.BoolLitContext):
        pass

    # Exit a parse tree produced by JavaParser#boolLit.
    def exitBoolLit(self, ctx:JavaParser.BoolLitContext):
        pass


    # Enter a parse tree produced by JavaParser#nullLit.
    def enterNullLit(self, ctx:JavaParser.NullLitContext):
        pass

    # Exit a parse tree produced by JavaParser#nullLit.
    def exitNullLit(self, ctx:JavaParser.NullLitContext):
        pass


    # Enter a parse tree produced by JavaParser#textLit.
    def enterTextLit(self, ctx:JavaParser.TextLitContext):
        pass

    # Exit a parse tree produced by JavaParser#textLit.
    def exitTextLit(self, ctx:JavaParser.TextLitContext):
        pass
